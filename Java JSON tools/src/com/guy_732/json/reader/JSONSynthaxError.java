...
{	
	 ...
	 */
	INVALID_DOCUMENT_START("Invalid document start", "Expected '[', '{', '\"', 'null', 'false', 'true' or number for a value"),
	 ...
	 */
	STRING_CONTAIN_CONTROL_CHAR("Invalid string, has control character", "A String cannot contain control character, use escape sequence instead.");
