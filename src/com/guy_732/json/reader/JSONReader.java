...
public abstract class JSONReader implements Closeable {
	 ...
	 * order mark in a character sequence should be ignored by a {@link JSONReader}.
	 */
	public static final char BYTE_ORDER_MARK = '\uFEFF';

	/**
	 * If this function returns true, {@link getAvailable()} should return minimum
	 * or a value greater than minimum. Ensures that a given minimum of characters
	 * is available to be consumed.
	 *
	 * @param minimum The minimum amount of character in the buffer.
	 * @return Whether the desired amount of available characters could be ensured
	 * or the end of the character sequence has been reached.
	 */
	 ...
	 *
	 * @return The next character in the character sequence. Must be non-negative.
	 */
	 ...
	 *
	 * <p>
	 * Callers must {@link JSONReader#makeAvailable(int) ensure}, that the desired
	 * amount of characters is available.
	 *
	 * @param offset The amount of characters to look ahead. Must be non-negative.
	 ...
	 * amount of characters is available.
	 *
	 * @param length The amount of characters to be consumed. Must be non-negative.
	 ...
	 * amount of characters is available.
	 *
	 * @param builder The string builder to add the characters to. Must be
	 *                non-negative.
	 * @param length  The amount of characters to be consumed.
	 */
	 ...
	 * @throws IOException         Thrown by {@link JSONReader#makeAvailable(int)
	 *                             JSONReader::makeAvailable(int)}
	 * @throws JSONSyntaxException Thrown if no characters are returned, use `err`
	 */
	public char nextNonWhitespace(JSONSynthaxError err) throws IOException, JSONSyntaxException {
